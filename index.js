		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD NS5-ROBOT*',
					benned: 'Você para a banda, por favor, contate o proprietário para abrir sua banda',
					ownerG: '[❗] NS5-ROBOT? Este é um recurso especial para o NS5-ROBOT ❌',
					ownerB: '[❗] NS5-ROBOT? Este é um recurso especial para o NS5-ROBOT ❌',
			...
			const ownerNumber = ["552796160640@s.whatsapp.net","552795195371@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"552796160640@s.whatsapp.net","552795195371@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["552796160640@s.whatsapp.net","552795195371@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["552796160640@s.whatsapp.net","552795195371@s.whatsapp.net"]//ubah nomor lo
			const premium = ["552796160640@s.whatsapp.net","552795195371@s.whatsapp.net"]
...
break
        ...
        case 'promover':
				...
				case 'ban':
					...
					mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
					if (mentioned.length > 1) {
						teks = 'Lixo removido com sucesso :\n'
						for (let _ of mentioned) {
							teks += `@${_.split('@')[0]}\n`
						}
						mentions(teks, mentioned, true)
